...
PDF einbinden: \includepdf[pagecommand={\thispagestyle{headings}},
	noautoscale=true,width=0.9\textwidth,offset=0cm -1cm]{content/pdf.pdf}

PDF einbinden: \\ 

\includegraphics[width=0.9\textwidth]{content/pdf.pdf}
...
\begin{figure}[!hb] % hier
	\centering
  \includegraphics[width=0.3\textwidth]{images/tux}
	% ====================
...
\includegraphics[height=2cm,width=3cm]{images/tux}
\includegraphics[angle=45, scale=.2]{images/tux}
...
\begin{figure}[!hb]% hier
	\centering
  \includegraphics[width=0.3\textwidth]{images/sudoku}
	% ====================
...
\begin{figure}[!hb]% hier
	\centering
  \includegraphics[angle=45,width=0.3\textwidth]{images/sudoku}
	% ====================
